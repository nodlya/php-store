                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('basket.minus', ['id' => $product->id]) }}"
                            ...
                            <button type="submit" class="m-0 p-0 border-0 bg-transparent">
                                <i class="fas fa-minus-square" data-feather="minus-square" style="width:17px"></i>
                            </button>
                        </form>
                        ...
                        <form action="{{ route('basket.plus', ['id' => $product->id]) }}"
                            ...
                            @csrf
                            <button type="submit" class="m-0 p-0 border-0 bg-transparent">
                                <i class="fas fa-plus-square" data-feather="plus-square" style="width:17px"></i>
                            </button>
                        </form>
                    </td>
                    ...
                    <td>
                        <form action="{{ route('basket.remove', ['id' => $product->id]) }}"
                            ...
                            @csrf
                            <button type="submit" class="m-0 p-0 border-0 bg-transparent">
                                <i class="fas fa-trash-alt text-danger " data-feather="trash-2" style="width:17px"></i>
                            </button>
                        </form>
                    </td>
                </tr>
